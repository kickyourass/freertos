 ...
 */
	...
	void prvListTaskWithinSingleList( const signed char *pcWriteBuffer, xList *pxList ,char* cStatus) PRIVILEGED_FUNCTION;
...
/*-----------------------------------------------------------*/
	...
	void prvListTaskWithinSingleList( const signed char *pcWriteBuffer, xList *pxList ,char* cStatus)
	{
